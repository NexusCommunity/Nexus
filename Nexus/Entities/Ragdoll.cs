...
namespace Nexus.Entities
{
    ...
    public class Ragdoll
    {
        ...
        public Ragdoll(RoleType roleType, global::Ragdoll.Info ragdollInfo, Vector3 position, Quaternion rotation = default, Vector3 velocity = default, 
            bool allowRecall = false, bool addToApi = false)
        {
        ...
        public static global::Ragdoll.Info DefaultRagdollOwner => new global::Ragdoll.Info()
        {
            ownerHLAPI_id = null,
            PlayerId = -1,
            DeathCause = new PlayerStats.HitInfo(-1f, "[REDACTED]", DamageTypes.Com15, -1, true),
        ...
        /// <summary>
        /// Gets the ragdoll's network ID.
        /// </summary>
        public uint NetId => ragdoll.netId;
        ...
        /// </summary>
        public Player Owner => PlayersList.Get(ragdoll.owner.PlayerId);

        /// <summary>
        /// Gets the killing <see cref="Player"/>. Can be null if the killer is not a player.
        /// </summary>
        public Player Killer => ragdoll.owner.DeathCause.IsPlayer ? PlayersList.Get(ragdoll.owner.DeathCause.RHub) : null;
        ...
        /// </summary>
        public Room Room => Map.FindRoom(GameObject);
                ...
                string mirrorOwnerId = null)
        {
            ...
            return Spawn(roleType, victimNick, new PlayerStats.HitInfo(@default.DeathCause.Amount, @default.DeathCause.Attacker, deathCause, -1, true), position, rotation, velocity, allowRecall, playerId, mirrorOwnerId);
        }
