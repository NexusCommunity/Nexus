...
using Nexus.Commands.Converters;
...
namespace Nexus.Commands
{
    ...
    public static class CommandManager
    {
        ...
        public static bool ExecuteCommand(CommandSource source, Player sender, string line)
        {
            ...
            {
                Log.Add("Nexus", $"An error occured while trying to execute the {cmd.Name} command! ({cmd.Method.DeclaringType.FullName}.{cmd.Method.Name})");
                Log.Add("Nexus", e);
