using Nexus.ModManager.Configs.Nexus;
...
public static class ConfigHolder
{
    ...
    /// <summary>
    /// Gets the <see cref="NexusConfiguration"/> instance.
    /// </summary>
    public static readonly NexusConfiguration Nexus = new NexusConfiguration();
